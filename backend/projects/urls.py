...
urlpatterns = [
    ...
    # NEW: user role persistence endpoint (called by frontend after modal confirm)
    # Example: POST /user/role/  { role, experience, skills }
    path('user/role/', UserRoleUpdateView.as_view(), name='user-role-update'),
