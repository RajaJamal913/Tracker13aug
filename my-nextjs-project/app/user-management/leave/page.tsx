...
const durationOptions = [
    { label: 'Separate duration for each', value: 'separate' },
    { label: 'One duration for all', value: 'one' }
  ];

  const policyOptions = [
    { label: 'Sick Leave', value: 'sick' },
    { label: 'Vacation', value: 'vacation' },
    { label: 'Monthly Leave', value: 'monthly' }
  ];

  const roleOptions = [
    { label: 'Owner', value: 'owner' },
    { label: 'Executive Manager', value: 'exec' },
  ...
  const [autoApprovedRoles, setAutoApprovedRoles] = useState([]);
  const [leaveDaysAdvance, setLeaveDaysAdvance] = useState(3);

  const handleSubmit = () => {
    const data = {
      duration: selectedDuration,
      leaveAdvanceDays: leaveDaysAdvance,
      leavePolicy: selectedPolicy,
      approvers: selectedApprovers,
      autoApprove: autoApprovedRoles
    };
...
// workdpace code 
  ...
  />
             ...
             <div className="col-md-6">
  <label className="form-label">Allow negative balance</label>
  <MultiSelect
    value={isMandatory}
    options={[
      { label: 'Yes', value: 'Yes' },
    ...
    onChange={(e) => setIsMandatory(e.value)}
    optionLabel="label"
    display="chip"
    placeholder="Select options"
    className="w-100"
...
<div className="col-md-6">
  ...
  <MultiSelect
    ...
    onChange={(e) => setBreakCategory(e.value)}
    optionLabel="label"
    display="chip"
 ...
 <div className="container mt-5">
   <div className="card border-0 shadow-sm">
      ...
      <div className="card-body p-4 shadow rounded" style={{ background: 'white' }}>
      

        <div className="mb-3">
          <label className="fw-bold">Policy Duration</label>
          <small className="d-block text-muted">Select duration option for Leave Policies</small>
          <Dropdown
 ...
 <label className="fw-bold">Leave Request</label>
          <small>How many days in advance should a team member submit a leave request?</small>
            ...
            <div>
              ...
              <input
                type="number"
                value={leaveDaysAdvance}
                // onChange={(e) => setLeaveDaysAdvance(e.target.value)}
                onChange={(e) => setLeaveDaysAdvance(Number(e.target.value))}
            ...
            <div className="flex-grow-1">
              <Dropdown
                ...
                onChange={(e) => setSelectedPolicy(e.value)}
        ...
        <div className="mb-3">
          <label className="fw-bold">Who can approve leave requests</label>
          <MultiSelect
            value={selectedApprovers}
            options={roleOptions}
            onChange={(e) => setSelectedApprovers(e.value)}
        ...
        <div className="mb-4">
          <label className="fw-bold">Whose leave requests will be auto-approved</label>
          <MultiSelect
            value={autoApprovedRoles}
            options={roleOptions}
            onChange={(e) => setAutoApprovedRoles(e.value)}
            placeholder="Select Roles"
            display="chip"
            className="w-100 mt-2"
          />
        ...
        <Button label="Save Changes" className="w-auto g-btn" onClick={handleSubmit} />
      </div>
    </div>
    </div>
    </>
